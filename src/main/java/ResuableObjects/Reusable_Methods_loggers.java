...
public class Reusable_Methods_loggers {
    ...
    //method to navigating to a page
    ...
    public static void clickMethod(ExtentTest logger, WebDriver driver, String locator, String elementName){
        ...
        try{
            ...
            clickbtn.click();
            logger.log(LogStatus.PASS, "Successfully clicked on the element" + elementName);
        }catch (Exception err){
    ...
    public static void mousemovement(ExtentTest logger, WebDriver driver, String locator, String elementName) throws IOException {
     try{
        ...
        logger.log(LogStatus.INFO,"Moving to " + elementName);
